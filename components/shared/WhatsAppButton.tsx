  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', zIndex: 10 }}
      >
        <Image src="/whatsapp.png" alt="WhatsApp" width={36} height={36} style={{ objectFit: 'contain' }} />
      </motion.div>
    </motion.a>
  )
}
