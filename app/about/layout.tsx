...
export const metadata: Metadata = {
  title: 'About MACTECH Building Materials Trading LLC | Industrial Supplier Since 2008',
  ...
  openGraph: {
    title: 'About MACTECH Building Materials Trading LLC — Your Industrial Partner',
