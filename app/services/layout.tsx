...
export const metadata: Metadata = {
  title: 'Industrial Services & Solutions | Fasteners, PPE, Welding Tools — MACTECH Building Materials Trading LLC',
  ...
  openGraph: {
    title: 'Industrial Services & Solutions — MACTECH Building Materials Trading LLC',
