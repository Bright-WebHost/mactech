...
export const metadata: Metadata = {
  ...
  title: {
    default: 'MACTECH Building Materials Trading LLC | Industrial & Building Materials Supplier — Muscat',
    template: '%s | MACTECH Building Materials Trading LLC',
  },
  ...
  openGraph: {
    ...
    siteName: 'MACTECH Building Materials Trading LLC',
    ...
    images: [{ url: 'https://www.mactechoman.com/mactech-logo.webp', width: 400, height: 400, alt: 'MACTECH Building Materials Trading LLC Industrial Supplier' }],
  },
  twitter: { card: 'summary_large_image', title: 'MACTECH Building Materials Trading LLC', description: 'Industrial supplier in Muscat, Oman', images: ['https://www.mactechoman.com/mactech-logo.webp'] },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const organizationJsonLd = {
    ...
    contactPoint: [
      { '@type': 'ContactPoint', telephone: '+968 99224564', contactType: 'sales', areaServed: 'OM', availableLanguage: ['English', 'Arabic'] },
      { '@type': 'ContactPoint', telephone: '+968 99224564', contactType: 'customer service', areaServed: 'OM' },
    ],
